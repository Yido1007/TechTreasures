...
class _ConsoleScreenState extends State<ConsoleScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        // Gaming Console Screen title
        title: Text(
          AppLocalizations.of(context).getTranslate("console"),
        ),
        centerTitle: true,
        actions: [
          Padding(
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                // Product Nanem
                Text(console[index]["name"].toString()),
                if (productCubit.isFavorite(console[index]["id"] as int))
                  // Button to remove the product to favorites
                  IconButton(
                    onPressed: () {
                      productCubit.removeFavorite(console[index]["id"] as int);
                    },
                    icon: const Icon(
                      Icons.favorite,
                      color: Colors.red,
                  ...
                  IconButton(
                    onPressed: () {
                      productCubit.addFavorite(console[index]);
                    },
            ...
            if (console[index]["in-stock"] as bool)
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Text(console[index]["price"].toString() +
            ...
            if (console[index]["in-stock"] as bool)
              ElevatedButton(
                ...
                onPressed: () {
                  cartCubit.addCart(
                    id: console[index]["id"] as int,
                    image: console[index]["image"].toString(),
                    name: console[index]["name"].toString(),
                    piece: 1,
                    price: console[index]["price"] as double,
                  );
