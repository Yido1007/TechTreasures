        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                // Product Nanem
                Text(tablet[index]["name"].toString()),
                if (productCubit.isFavorite(tablet[index]["id"] as int))
                  // Button to remove the product to favorites
                  IconButton(
                    onPressed: () {
                      productCubit.removeFavorite(tablet[index]["id"] as int);
                    },
                    icon: const Icon(
                      Icons.favorite,
                      color: Colors.red,
                  ...
                  IconButton(
                    onPressed: () {
                      productCubit.addFavorite(tablet[index]);
                    },
            ...
            if (tablet[index]["in-stock"] as bool)
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Text(tablet[index]["price"].toString() +
            ...
            if (tablet[index]["in-stock"] as bool)
              ElevatedButton(
                ...
                onPressed: () {
                  cartCubit.addCart(
                    id: tablet[index]["id"] as int,
                    image: tablet[index]["image"].toString(),
                    name: tablet[index]["name"].toString(),
                    piece: 1,
                    price: tablet[index]["price"] as double,
                  );
