  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        // Laptop Screen title
        title: Text(
          AppLocalizations.of(context).getTranslate("laptop"),
        ),
        centerTitle: true,
        actions: [
          Padding(
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                // Product Nanem
                Text(laptop[index]["name"].toString()),
                if (productCubit.isFavorite(laptop[index]["id"] as int))
                  // Button to remove the product to favorites
                  IconButton(
                    onPressed: () {
                      productCubit.removeFavorite(laptop[index]["id"] as int);
                    },
                    icon: const Icon(
                      Icons.favorite,
                      color: Colors.red,
                  ...
                  IconButton(
                    onPressed: () {
                      productCubit.addFavorite(laptop[index]);
                    },
            ...
            if (laptop[index]["in-stock"] as bool)
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Text(laptop[index]["price"].toString() +
            ...
            if (laptop[index]["in-stock"] as bool)
              ElevatedButton(
                ...
                onPressed: () {
                  cartCubit.addCart(
                    id: laptop[index]["id"] as int,
                    image: laptop[index]["image"].toString(),
                    name: laptop[index]["name"].toString(),
                    piece: 1,
                    price: laptop[index]["price"] as double,
                  );
