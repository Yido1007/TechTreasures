...
class _KeyboardScreenState extends State<KeyboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        // keyboard Screen title
        title: Text(
          AppLocalizations.of(context).getTranslate("keyboard"),
        ),
        centerTitle: true,
        actions: [
          Padding(
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                // Product Nanem
                Text(keyboard[index]["name"].toString()),
                if (productCubit.isFavorite(keyboard[index]["id"] as int))
                  // Button to remove the product to favorites
                  IconButton(
                    onPressed: () {
                      productCubit.removeFavorite(keyboard[index]["id"] as int);
                    },
                    icon: const Icon(
                      Icons.favorite,
                      color: Colors.red,
                  ...
                  IconButton(
                    onPressed: () {
                      productCubit.addFavorite(keyboard[index]);
                    },
            ...
            if (keyboard[index]["in-stock"] as bool)
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Text(keyboard[index]["price"].toString() +
            ...
            if (keyboard[index]["in-stock"] as bool)
              ElevatedButton(
                ...
                onPressed: () {
                  cartCubit.addCart(
                    id: keyboard[index]["id"] as int,
                    image: keyboard[index]["image"].toString(),
                    name: keyboard[index]["name"].toString(),
                    piece: 1,
                    price: keyboard[index]["price"] as double,
                  );
