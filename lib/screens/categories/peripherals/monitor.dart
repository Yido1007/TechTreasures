        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                // Product Nanem
                Text(monitor[index]["name"].toString()),
                if (productCubit.isFavorite(monitor[index]["id"] as int))
                  // Button to remove the product to favorites
                  IconButton(
                    onPressed: () {
                      productCubit.removeFavorite(monitor[index]["id"] as int);
                    },
                    icon: const Icon(
                      Icons.favorite,
                      color: Colors.red,
                  ...
                  IconButton(
                    onPressed: () {
                      productCubit.addFavorite(monitor[index]);
                    },
            ...
            if (monitor[index]["in-stock"] as bool)
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Text(monitor[index]["price"].toString() +
            ...
            if (monitor[index]["in-stock"] as bool)
              ElevatedButton(
                ...
                onPressed: () {
                  cartCubit.addCart(
                    id: monitor[index]["id"] as int,
                    image: monitor[index]["image"].toString(),
                    name: monitor[index]["name"].toString(),
                    piece: 1,
                    price: monitor[index]["price"] as double,
                  );
