...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Tech Treasure"),
        centerTitle: true,
        actions: [
          Padding(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                if (productCubit.isFavorite(products[index]["id"] as int))
                  // Button to remove the product to favorites
                  IconButton(
                    onPressed: () {
                      productCubit.removeFavorite(products[index]["id"] as int);
                    },
                    icon: const Icon(
                      Icons.favorite,
                      color: Colors.red,
                  ...
                  IconButton(
                    onPressed: () {
                      productCubit.addFavorite(products[index]);
                    },
